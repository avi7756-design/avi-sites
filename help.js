...
(function () {
  ...
  var HELP = {
    ...
    'learning-log': {
      title: '🧠 יומן למידה',
      what: 'מתעד כל החלטה (קנית/דחית) ואת התוצאה בפועל - והמערכת לומדת מה עובד.',
      why: 'אחרי כמה עסקאות תראה דפוס: אילו גורמים מנבאים הצלחה ואילו כישלון. ככה משתפרים.',
      steps: [
        ['📓', 'רשום החלטה', 'עסקה, החלטה (קנית/דחית), והגורמים שהשפיעו (רכבת? מפגע?).'],
        ['🎯', 'עדכן תוצאה', 'כשתדע מה קרה (הערך עלה/ירד) - עדכן. זה הדלק של הלמידה.'],
        ['🧠', 'תובנות', 'שיעור הצלחה + אילו גורמים חוזרים בעסקאות מוצלחות מול כושלות.'],
        ['🤖', 'ניתוח עומק', 'כפתור שמייצר פרומפט עם כל ההיסטוריה ל-ChatGPT/Claude לניתוח דפוסים.']
      ],
      tip: 'גם החלטות "דחיתי" חשובות - אם דחית ואז הערך שם צנח, צדקת. תעד הכל.'
    },
    'area-research': {
      title: '🗺️ מחקר אזור',
      what: 'מפה של כל שכונה בקריות - מה המחיר, מה מעלה ערך (מנופים) ומה מסוכן.',
      why: 'לפני שקונים באזור - לדעת אם יש רכבת/התחדשות בדרך (ערך עולה) או מפגע (ערך יורד).',
      steps: [
        ['💰', 'נתוני אזור', 'לכל שכונה: מחיר למ"ר, תשואה, מנופי ערך (ירוק) וסיכונים (אדום).'],
        ['🔎', 'פרומפט מחקר', 'לחיצה מייצרת שאלה מוכנה ל-Perplexity על תחבורה, התחדשות ומפגעים באזור.'],
        ['📝', 'שמירת ממצאים', 'מדביק את תשובת Perplexity - היא נשמרת בהערות עם תאריך.'],
        ['🕒', 'עדכון מתמשך', 'כל אזור מראה מתי עודכן לאחרונה - כך הידע נשאר טרי.']
      ],
      tip: 'אזור עם מנוף ערך (רכבת/התחדשות) ובלי סיכון = שם מחפשים יהלומים. אמת מחירים ב-nadlan.gov.il.'
    },
    'deals-db': {
